...
driver = webdriver.Firefox(service_log_path="C:\Python\geckodriver.log")
driver.get(url_tui1)
...
file = openpyxl.load_workbook('C:\Python\Cena_Madery\madera2020.xlsx')
sheet = file.active
sheet.append([data, cena, url_tui1])
file.save('C:\Python\Cena_Madery\madera2020.xlsx')
file.close()
